...
const R = JSON.parse(
  readFileSync(new URL("../docs/loadtest/loadtest-llm-600-async-results.json", import.meta.url)),
);
...
for (const [key, t] of Object.entries(L)) {
  const out = new URL(`../docs/loadtest/loadtest_llm_600_api_${key}.html`, import.meta.url);

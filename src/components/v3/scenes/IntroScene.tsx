...
const INTRO_BG = "/vision_express/common/table.jpg";
const BG_STATION = "/vision_express/common/inside-station.jpg";
const BG_TRAIN = "/vision_express/common/arriving-train.jpg";
...
const LETTER_UNFOLD = "/vision_express/common/letter_ver2.jpg";

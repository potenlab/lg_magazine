...
/**
 * ── [v1 — 2026-05-19 백업] ──────────────────────────────────────
 * 새 합본 매거진(4 챕터 article + cards spread) 버전으로 교체되면서
 * 원본 보존용으로 남겨둠. 활성화하려면:
 *   1) scenes/index.ts 의 `magazinePoster: MagazinePosterScene` 매핑을
 *      `MagazinePosterSceneV1` 로 변경
 *   2) 새 MagazinePosterScene.tsx 를 백업/삭제
 *
 ...
 */
export function MagazinePosterSceneV1({
  spec,
  onAdvance,
}: {
  spec: SceneSpec;

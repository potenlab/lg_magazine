...
const BG_NIGHT = "/vision_express/common/Chapter03-1.avif";
const BG_FOG = "/vision_express/common/Chapter03.avif";
const BG_ROOM = "/vision_express/common/Chapter03.avif";
...
export const CH3_SCENES: SceneSpec[] = [
  ...
  // ── [13p] 도구 선택 — 지금 잘 쓰는 도구 / 키우고 싶은 도구 ──
  {
    ...
    lines: [
      "그리고 하나 더.",
      "{name}님이 성과를 만들 때 주로 쓰는 도구와 앞으로 더 키우고 싶은 도구는 무엇인가요?",
    ],
    editorNote:
